//
//  NetDuagnoViewController.m
//  Yddworkspace
//
//  Created by ydd on 2020/5/25.
//  Copyright © 2020 QH. All rights reserved.
//

#import "NetDuagnoViewController.h"
#import "LDNetDiagnoService.h"
#import "LDNetGetAddress.h"

@interface NetDuagnoViewController () <LDNetDiagnoServiceDelegate, UITextFieldDelegate>
{
...
@implementation NetDuagnoViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    [LDNetGetAddress getPublicNetworkIpCompleted:^(KXUserIpModel *model) {
    ...
    _txtfield_dormain.text = @"www.17kuxiu.com/www.baidu.com/www.weixin.com/www.tencent.com";
...
- (void)startNetDiagnosis
{
    ...
    _netDiagnoService.dormainArray = [_txtfield_dormain.text componentsSeparatedByString:@"/"];
    if (!_isRunning) {
