...
@interface MyImagePickerViewController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
@property (nonatomic, strong) void (^callBackStr)(UIImage *image);
...
- (void)viewDidLoad {
    ...
    if (_canCa) {
        ...
        [self customUI];
        //弹簧动画api
//         [UIView animateWithDuration:3 delay:0 usingSpringWithDamping:<#(CGFloat)#> initialSpringVelocity:<#(CGFloat)#> options:UIViewAnimationOptionAllowUserInteraction animations:^{
//             
...
- (void)customUI{
    ...
    backBtn.frame = CGRectMake(20, 20, 50, 30);
