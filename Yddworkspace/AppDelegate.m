...
{
    [[[UIAlertView alloc] initWithTitle:url.absoluteString message:[NSString stringWithFormat:@"options:%@", options] delegate:nil cancelButtonTitle:nil otherButtonTitles:@"关闭", nil] show];
    return YES;
}
