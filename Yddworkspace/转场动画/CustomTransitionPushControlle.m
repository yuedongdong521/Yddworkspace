//
//  CustomTransitionPushControlle.m
//  Yddworkspace
//
...
@implementation CustomTransitionPushControlle
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    CustomPushAnimateViewController *fromVc = [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    //获取目标控制器 注意不要写成 UITransitionContextToViewKey
    CustomPopAnimateViewController *toVc = [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
