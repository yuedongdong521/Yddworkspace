...
- (void)setModel:(TZAssetModel *)model {
    ...
    //选择按钮图片
//    self.selectImageView.image = self.selectPhotoButton.isSelected ? [UIImage imageNamed:KYselect_yes] : [UIImage imageNamed:KYselect_no];
    self.type = (TZAssetCellType)model.type;
...
//    self.selectImageView.image = sender.isSelected ? [UIImage imageNamed:KYselect_yes] : [UIImage imageNamed:KYselect_no];
...
- (UIButton *)selectPhotoButton {
    if (_selectImageView == nil) {
        ...
        selectPhotoButton.backgroundColor = [UIColor clearColor];
...
- (UIImageView *)selectImageView {
    if (_selectImageView == nil) {
        ...
        selectImageView.frame = CGRectMake(self.tz_width - 26, 10, 16, 16);
...
- (UIButton *)selectedCountButton {
    if (_selectedCountButton == nil) {
      ...
      selectedCountButton.backgroundColor = [UIColor colorWithRed:246 / 255.0 green:212 / 255.0 blue:48 / 255.0 alpha:1];
        [selectedCountButton setTitleColor:[UIColor colorWithRed:30 / 255.0 green:30 / 255.0 blue:30 / 255.0 alpha:1] forState:UIControlStateNormal];
